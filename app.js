// -------------------------------------------------------------------------------------------------------------- //
// Purpose: JS script to take user input on ingredient, units and value, and convert to desired units. Also shows
// 			units based on ingredient selection (wet and dry ingredients have different unit options), and 
//			includes input validation for the conversion form.
// Created: 2018 (some very minor updates since then, but not much)
// -------------------------------------------------------------------------------------------------------------- //
...
// Define functions to use in logic

// REMOVED CONTACT PAGE (UNNECESSARY) SO THIS FUNCTION IS NO LONGER NEEDED
...
//calculation functions - one for each conversion
...
//when the "Go!" button is clicked, check for empty or invalid inputs and display relevant errors, then if all inputs are valid perform the calculation and display the result
...
// REMOVED CONTACT PAGE (UNNECESSARY)
